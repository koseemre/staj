...
public class History extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listApps = (ListView)findViewById(R.id.ListForHistory);

        Call<List<Person>> callPersons = userService.GetMyReqHistoryFunc(eventPerson.getUsername());
        callPersons.enqueue(new Callback<List<Person>>() {
            ...
            public void onResponse(Call<List<Person>> call, Response<List<Person>> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    List<Person> myRequests = response.body();
                    FeedAdapterForHistory feedAdapter = new FeedAdapterForHistory(History.this,R.layout.list_record_history,myRequests);
